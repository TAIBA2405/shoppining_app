    ...
    <div style={{
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-heading)', fontSize: 'var(--text-2xl)', fontWeight: 800, marginBottom: 4 }}>
            Admin Login
          </h1>
          <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-tertiary)' }}>
            StyleVerse Admin Panel
          </p>
        </div>
        ...
        <div style={{
          ...
          marginBottom: 20, fontSize: 'var(--text-xs)', color: 'var(--text-secondary)',
          lineHeight: 1.6
        }}>
          <strong style={{ color: 'var(--color-primary)' }}>Demo credentials pre-filled.</strong><br />
          Email: admin@styleverse.com Â· Password: admin123
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 24, fontSize: 'var(--text-xs)', color: 'var(--text-tertiary)' }}>
          <a href="http://localhost:5173" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none' }}>
